...
- (void)viewDidLoad {
    ...
    NSDictionary<NSString *, NSEntityDescription *> *entities = self.persistentContainer.managedObjectModel.entitiesByName;
...
-(void) add {
    AddUserTableViewController *addVc = [[AddUserTableViewController alloc] initWithStyle:UITableViewStylePlain];
