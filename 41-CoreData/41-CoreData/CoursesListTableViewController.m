//
//  CoursesListTableViewController.m
//  41-CoreData
//
//  Created by iMac on 09/06/2019.
...
@interface CoursesListTableViewController ()

@end

@implementation CoursesListTableViewController
...
-(void) add {
    AddCourseTableViewController *addCourseVc = [[AddCourseTableViewController alloc] initWithStyle:UITableViewStylePlain];
